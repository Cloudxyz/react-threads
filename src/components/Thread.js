...
export const Thread = ({setShowPopUp, filterThread, user, getThreads}) => {
  ...
  return (
    <article className="feed-card">
      ...
      <p className="sub-text"><span onClick={handleClick}>x replies</span> • <span>{likes.length} likes</span></p>
    </article>
  );
}